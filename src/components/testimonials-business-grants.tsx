...
export default function TestimonialsBusinessGrants() {
  return (
    <section className="py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center space-y-4 mb-16">
          <h2 className="text-balance text-4xl font-medium lg:text-5xl">What Our Business Grant Partners Say</h2>
          <p className="text-muted-foreground text-lg">Real feedback from business grant consultants who've transformed their businesses</p>
        </div>

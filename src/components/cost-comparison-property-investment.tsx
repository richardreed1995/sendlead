...
export default function CostComparisonPropertyInvestment() {
  return (
    <section className="py-16 bg-gray-50">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="relative z-10 mx-auto max-w-xl space-y-4 text-center md:space-y-8 mb-12">
            <h2 className="text-balance text-4xl font-medium lg:text-5xl">The Real Cost of DIY Property Investment Lead Generation</h2>

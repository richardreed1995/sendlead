...
const flows = [
  {
    ...
    description: "Before you spend a penny, we analyse your business loan operation and show you exactly how much money you could make by working with us. No surprises, just clear projections based on real industry data.",
    image: "/Group 13.png",
    alt: "Financial + ROI Modelling"
  },
  {
    title: "We Create Your Funnel",
    description: "We build a complete business loan acquisition system that looks and feels like your brand. When potential customers interact with us, they think they're dealing directly with you.",
    image: "/Group 12.png",

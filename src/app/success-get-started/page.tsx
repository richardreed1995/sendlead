    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="text-center px-4 flex-1 flex flex-col">
        ...
        <div className="max-w-2xl mx-auto mb-4">
          <h1 className="text-2xl sm:text-3xl font-black text-gray-900 mb-3">Thanks for getting in touch!</h1>
        ...
        <div className="max-w-2xl mx-auto mb-12">
          <p className="text-gray-600 mb-4">Or message us directly</p>
          <Link 
          ...
          >
            <Button 
              size="lg" 
              className="bg-[#25D366] hover:bg-[#20BA5A] text-white px-8 py-6 flex items-center justify-center gap-3 text-lg font-semibold"
            >
              <svg 
        ...
        <div className="max-w-4xl mx-auto mb-16 px-4">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">Step 2: Review our presentation</h2>

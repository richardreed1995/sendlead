      ...
      <main className="flex-1 w-full max-w-2xl mx-auto px-4 pt-32 pb-20">
        <article className="prose prose-lg mx-auto text-center [&_h2]:font-bold [&_h2]:text-2xl [&_h2]:text-gray-900 [&_h2]:mb-6 [&_h2]:mt-12 [&_h2]:border-b [&_h2]:border-gray-200 [&_h2]:pb-3 [&_h3]:font-semibold [&_h3]:text-xl [&_h3]:text-gray-800 [&_h3]:mb-4 [&_h3]:mt-8">
          ...
          <div className="text-left space-y-8 text-lg leading-relaxed px-2 md:px-8">
            ...
            <h2 id="problem">The Problem Every Business Faces</h2>
            ...
            <h2 id="introducing-parlance">Introducing Parlance: Your AI-Powered Conversion System</h2>
            ...
            <h3 id="what-makes-different">What Makes Parlance Different?</h3>
            <ul className="list-disc pl-6 space-y-1">
            ...
            <h2 id="how-parlance-works">How Parlance Works</h2>
            ...
            <h2 id="future-of-lead-nurturing">The Future of Lead Nurturing is Here</h2>

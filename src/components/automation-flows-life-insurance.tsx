...
export default function AutomationFlowsLifeInsurance() {
  return (
    <section className="py-24 bg-white">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="relative z-10 mx-auto max-w-xl space-y-4 text-center md:space-y-8 mb-16">
          <h2 className="text-balance text-4xl font-medium lg:text-5xl">How We Generate Your Life Insurance Leads</h2>
          <p className="text-muted-foreground text-base md:text-lg">Our proven 5-step process for delivering qualified life insurance leads</p>
        </div>
